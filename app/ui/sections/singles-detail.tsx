...
export default function SectionSingleDetail() {
  ...
  const contents = [
    <div>
      <div key={2} className="pt-12 pr-20 text-2xl">鲁迅书店</div>
      <div key={1} className="pt-12 pr-20 text-xl indent-8">
    ...
    <div>
      <div key={2} className="pt-12 pr-20 text-2xl">中国书店读者服务部</div>
      <div key={0} className="pt-12 pr-20 text-xl indent-8">
    ...
    <div>
    <div key={2} className="pt-12 pr-20 text-2xl">纪府书房</div>
      <div key={1} className="pt-12 pr-20 text-xl indent-8">
    ...
    <div>
      <div key={2} className="pt-12 pr-20 text-2xl">中国书店雁翅楼店</div>
      <div key={1} className="pt-12 pr-20 text-xl indent-8">
        在众多书店中，中国书店因收购、经营古旧书而独树一帜。成立70多年来，这家由100多家旧书摊、书店合并而成的书店，搜寻过淹没在废纸里的文献，办过临时搭建几排棚子的古籍书市，还把拍卖引入古旧书业。如今，中国书店更是通过重印、再版等形式令绝版古旧书延续生命，并将古籍零页装裱成“片羽存真”文创产品，让古旧书与读者、藏家实现了美丽邂逅。
        2015年，位于地安门十字路口路南的雁翅楼挂上了“中国书店”的牌匾，这是中国书店旗下首家“不打烊”书店，也是北京市属第一家国有24小时书店。
      </div>
